        ...
        <div class="container">
            ...
            <div class="row">
                                            ...
                                            <td>
                                                <figure class="media">
                                                    <figcaption class="media-body">
                                                        <h6 class="title text-turncate">{{ Str::words($item->name, 20) }}</h6>
                ...
                <aside class="col-sm-3">
                    ...
                    <p class="alert alert-success">Add USD 5.00 of eligible items to your order to quality for FREE Shipping. </p>
                    ...
                    <figure class="itemside mb-3">
                        <aside class="aside">
                            ...
                            <div class="text-wrap small text-muted">
                                Pay by Mastercard and savce 40%
