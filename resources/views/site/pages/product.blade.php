                                ...
                                <article class="p-5">
                                    ...
                                    <div class="mb-3">
                                        @if ($product->sale_price>0)
                                            <var class="price x3 text-danger">
                                            ...
                                            <dl class="dlist-inline">
                                                @foreach ($attributes as $attribute)
                                                    ...
                                                    @if($attributeCheck)
                                                        ...
                                                        <dd>
                                                            <select name="{{ strtolower($attribute->name)}}" id="" class="form-control form-control-sm option" style="width:180px">
                                                                <option value="0" data-price="0">Select a {{ $attribute->name }}</option>

                                                                @foreach ($product->attributes as $attributeValue)
                                                                    @if ($attributeValue->attribute_id == $attribute->id)
                                                                        <option value="{{ $attributeValue->value }}" data-price="{{ $attributeValue->price }}">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12">
                                            <dl class="dlist-inline">
                                                <dt>Quantity:</dt>
                                                <dd>
                                                    <input type="number" class="form-control" name="qty" min="1" max="{{ $product->quantity }}" style="width:70px" value="1">
