                            ...
                            <aside class="col-sm-7">
                                <article class="p-5">
                                    ...
                                    <form action="{{ route('product.add.cart') }}" method="POST" id="addToCart">
                                                ...
                                                <dl class="dlist-inline">
                                                    @foreach($attributes as $attribute)
                                                        ...
                                                        @if($attributeCheck)
                                                            ...
                                                            <dd>
                                                                <select name="{{ strtolower($attribute->name) }}" id="" class="form-control form-control-sm option">
                                        ...
                                        <hr>
                                        <button class="btn btn-sm btn-success"><i class="fa fa-shopping-cart">Add To Cart</i></button>
                                    </form>
                                </article>
                            </aside>
                        </div>
